    ...
    <section className='text-center bg-indigo-600/30 my-4 h-full w-full'>
      ...
      <div className='flex flex-row group w-40 mdt:w-48 lg:w-56 m-0 ml-auto mr-auto lg:mr-8 justify-between border-2 bg-white border-indigo-950 hover:border-indigo-500 rounded'>
        <input
          ...
          placeholder='Search'
        />
        <button onClick={handleInputSearch} className='w-[25%] border-l-2 h-fit py-1 px-2 mdt:px-3 lg:px-4 justify-self-center hover:bg-indigo-200 ease-in-out active:shadow-bbx active:transition-shadow'>
      ...
      <div>
        <div className="flex flex-wrap justify-around items-center">
          {cities?.length > 0 ?
            ...
            City not found <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
